                    ...
                    <div class="room-service-carousel">
                        ...
                        <div class="item col-lg-12" index="<?php echo $key?>">
                            <a href="<?php echo $this->request->createLink($sitemap['sitemapid'])?>" pagetype="<?php echo $sitemap['sitemaptype']?>" video="<?php echo $sitemap['video']?>">
                                ...
                                <img src="<?php echo $sitemap['image']?>" sitemapname="<?php echo $sitemap[$this->request->translate('sitemapname')]!=''?$sitemap[$this->request->translate('sitemapname')]:$sitemap['sitemapname']?>">
                            </a>
                        </div>
                        <?php } ?>
                    </div>
