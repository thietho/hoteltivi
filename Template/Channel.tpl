        ...
        <div class="row">
            <div class="col-lg-3 pl-0">
                <div class="list-group">
                    <a href="<?php echo $this->request->createLink('listchannel')?>" class="list-group-item list-group-item-action list-group-channel">Tất cả các kênh</a>
                    <?php foreach($channelGroups as $key => $group){ ?>
                    <a href="<?php echo $this->request->createLink('listchannel')?>?group=<?php echo $key?>" class="list-group-item list-group-item-action list-group-channel"><?php echo $group?></a>
                    <?php } ?>
                </div>
            </div>
