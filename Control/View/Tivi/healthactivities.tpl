        ...
        <div class="row">
            <div class="col-lg-4 sub-menu-title">
                <div class="text-wrapper">
                    <p class="top">entertaiment</p>
                    <p class="bottom">activities</p>
                </div>
            </div>
            <div class="col-lg-6 sub-menu-breadcrumb">
                <div class="text-wrapper">
                    ...
                    <div class="bottom">
                        <p>Home <img src="img/right-arrow.png"/> Entertaiment Activities</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 main-sidebar">
                <div class="sidebar-carousel">
                    <div class="item">
                        <a href="#">
                            <p>SAJE SPA</p>
                            <img src="img/activities-1.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <p>SANES GYM</p>
                            <img src="img/activities-2.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <p>BEACH SPORTS</p>
                            <img src="img/activities-3.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
